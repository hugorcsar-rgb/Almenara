...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const I18N = {
    en: {
      "meta.title": "Almenara — 300 lm/W LED modules with Dicrotec technology",
      "meta.desc": "LED modules with patented Dicrotec technology: 300 lm/W indoors (LED 3030) and 58% less energy than a standard LED module at equal flux (2,000 lm). For new and existing luminaires.",
      "meta.locale": "en_GB",
    "a11y.menu": "Menu",
    ...
    "cct.label": "Colour temperature",
      ...
      "hero.title_a": "300 lumens per watt,", "hero.title_b": "on any luminaire.",
      "hero.sub": "LED modules with patented Dicrotec technology, for manufacturers, specifiers and infrastructure operators. 300 lm/W in indoor modules (LED 3030). They fit new luminaires and replace the light source in those already installed.",
      "hero.cta1": "Request the technical brief", "hero.cta2": "See the sectors",
      "scale.label": "Luminous efficacy · lumens per watt", "scale.axis": "Scale 0 – 350 lm/W",
      "scale.inc": "Incandescent", "scale.fluo": "Fluorescent", "scale.mh": "Metal halide",
      "scale.led": "Commercial LED", "scale.self": "Us",
      "scale.note": "Comparison values are typical market ranges for each technology. Our figure: Dicrotec indoor module, LED 3030, LM-79 test at an accredited laboratory (NVLAP).",
      "metrics.aria": "Key figures", "metrics.efficacy": "Indoor module · LED 3030", "metrics.energy": "vs standard LED module · 2,000 lm",
      "metrics.compat_v": "Class A",
      "plat.label": "Us",
      "plat.title": "The change that has to happen is here.",
      "plat.body": "Europe has to replace the lighting it has installed with lighting that consumes less. On the European energy label, Class A starts at 210 lumens per watt (Regulation (EU) 2019/2015). Our indoor modules deliver 300.",
      "plat.cta": "Request the technical brief →",
      "adv.label": "Why it is worth the switch",
      "adv.1t": "Efficacy above the commercial ceiling",
      "adv.1b": "300 lm/W in Dicrotec indoor modules. At equal flux (2,000 lm): 6.7 W against 16 W for a standard LED module.",
    ...
    es: {
      "meta.title": "Almenara — Módulos LED de 300 lm/W con tecnología Dicrotec",
      "meta.desc": "Módulos LED con tecnología patentada Dicrotec: 300 lm/W en interior (LED 3030) y un 58% menos de energía que un módulo LED estándar a igual flujo (2.000 lm). Para luminarias nuevas e instaladas.",
      "meta.locale": "es_ES",
    "a11y.menu": "Menú",
    ...
    "cct.label": "Temperatura de color",
      ...
      "hero.title_a": "300 lúmenes por vatio,", "hero.title_b": "en cualquier luminaria.",
      "hero.sub": "Módulos LED con tecnología patentada Dicrotec, para fabricantes, prescriptores y operadores de infraestructura. 300 lm/W en módulos interiores (LED 3030). Encajan en luminarias nuevas y sustituyen la fuente de luz en las ya instaladas.",
      "hero.cta1": "Solicitar la ficha técnica", "hero.cta2": "Ver los sectores",
      "scale.label": "Eficacia luminosa · lúmenes por vatio", "scale.axis": "Escala 0 – 350 lm/W",
      ...
      "scale.note": "Los valores de comparación son rangos típicos de mercado para cada tecnología. Nuestra cifra: módulo interior Dicrotec, LED 3030, ensayo LM-79 en laboratorio acreditado (NVLAP).",
      "metrics.aria": "Cifras principales", "metrics.efficacy": "Módulo interior · LED 3030", "metrics.energy": "frente a LED estándar · 2.000 lm",
      "metrics.compat_v": "Clase A",
      "plat.label": "Nosotros",
      "plat.title": "El cambio necesario está aquí.",
      "plat.body": "Europa tiene que sustituir la iluminación instalada por otra que consuma menos. En la etiqueta energética europea, la clase A empieza en 210 lúmenes por vatio (Reglamento (UE) 2019/2015). Nuestros módulos interiores dan 300.",
      "plat.cta": "Solicitar la ficha técnica →",
      "adv.label": "Por qué compensa el cambio",
      "adv.1t": "Eficacia por encima del techo comercial",
      "adv.1b": "300 lm/W en módulos interiores Dicrotec. A igual flujo (2.000 lm): 6,7 W frente a 16 W de un módulo LED estándar.",
    ...
    pt: {
      "meta.title": "Almenara — Módulos LED de 300 lm/W com tecnologia Dicrotec",
      "meta.desc": "Módulos LED com tecnologia patenteada Dicrotec: 300 lm/W em interior (LED 3030) e menos 58% de energia do que um módulo LED padrão com o mesmo fluxo (2.000 lm). Para luminárias novas e instaladas.",
      "meta.locale": "pt_PT",
    "a11y.menu": "Menu",
    ...
    "cct.label": "Temperatura de cor",
      ...
      "hero.title_a": "300 lúmens por watt,", "hero.title_b": "em qualquer luminária.",
      "hero.sub": "Módulos LED com tecnologia patenteada Dicrotec, para fabricantes, projetistas e operadores de infraestruturas. 300 lm/W em módulos interiores (LED 3030). Encaixam em luminárias novas e substituem a fonte de luz nas já instaladas.",
      "hero.cta1": "Pedir a ficha técnica", "hero.cta2": "Ver os sectores",
      "scale.label": "Eficácia luminosa · lúmenes por watt", "scale.axis": "Escala 0 – 350 lm/W",
      "scale.inc": "Incandescente", "scale.fluo": "Fluorescente", "scale.mh": "Iodetos metálicos",
      "scale.led": "LED comercial", "scale.self": "Nós",
      "scale.note": "Os valores de comparação são intervalos típicos de mercado para cada tecnologia. O nosso valor: módulo interior Dicrotec, LED 3030, ensaio LM-79 em laboratório acreditado (NVLAP).",
      "metrics.aria": "Valores principais", "metrics.efficacy": "Módulo interior · LED 3030", "metrics.energy": "face a LED padrão · 2.000 lm",
      "metrics.compat_v": "Classe A",
      "plat.label": "Nós",
      "plat.title": "A mudança necessária está aqui.",
      "plat.body": "A Europa tem de substituir a iluminação instalada por outra que consuma menos. Na etiqueta energética europeia, a classe A começa nos 210 lúmens por watt (Regulamento (UE) 2019/2015). Os nossos módulos interiores dão 300.",
      "plat.cta": "Pedir a ficha técnica →",
      "adv.label": "Porque compensa mudar",
      "adv.1t": "Eficácia acima do tecto comercial",
      "adv.1b": "300 lm/W em módulos interiores Dicrotec. Com o mesmo fluxo (2.000 lm): 6,7 W face a 16 W de um módulo LED padrão.",
    ...
    fr: {
      "meta.title": "Almenara — Modules LED de 300 lm/W avec la technologie Dicrotec",
      "meta.desc": "Modules LED à technologie brevetée Dicrotec : 300 lm/W en intérieur (LED 3030) et 58 % d'énergie en moins qu'un module LED standard à flux égal (2 000 lm). Pour luminaires neufs et existants.",
      "meta.locale": "fr_FR",
    "a11y.menu": "Menu",
    "form.sending": "Envoi…",
    ...
    "cct.label": "Température de couleur",
      ...
      "hero.title_a": "300 lumens par watt,", "hero.title_b": "sur tout luminaire.",
      "hero.sub": "Modules LED à technologie brevetée Dicrotec, pour fabricants, prescripteurs et gestionnaires d'infrastructures. 300 lm/W en modules intérieurs (LED 3030). Ils s'intègrent aux luminaires neufs et remplacent la source lumineuse de ceux déjà installés.",
      "hero.cta1": "Demander la fiche technique", "hero.cta2": "Voir les secteurs",
      "scale.label": "Efficacité lumineuse · lumens par watt", "scale.axis": "Échelle 0 – 350 lm/W",
      "scale.inc": "Incandescence", "scale.fluo": "Fluorescent", "scale.mh": "Iodures métalliques",
      "scale.led": "LED du marché", "scale.self": "Nous",
      "scale.note": "Les valeurs de comparaison sont des plages de marché typiques pour chaque technologie. Notre valeur : module intérieur Dicrotec, LED 3030, essai LM-79 en laboratoire accrédité (NVLAP).",
      "metrics.aria": "Chiffres clés", "metrics.efficacy": "Module intérieur · LED 3030", "metrics.energy": "face à un LED standard · 2 000 lm",
      "metrics.compat_v": "Classe A",
      "plat.label": "Nous",
      "plat.title": "Le changement nécessaire est là.",
      "plat.body": "L'Europe doit remplacer l'éclairage installé par un éclairage qui consomme moins. Sur l'étiquette énergétique européenne, la classe A commence à 210 lumens par watt (Règlement (UE) 2019/2015). Nos modules intérieurs en délivrent 300.",
      ...
      "adv.1b": "300 lm/W dans les modules intérieurs Dicrotec. À flux égal (2 000 lm) : 6,7 W contre 16 W pour un module LED standard.",
    ...
    de: {
      "meta.title": "Almenara — LED-Module mit 300 lm/W und Dicrotec-Technologie",
      "meta.desc": "LED-Module mit patentierter Dicrotec-Technologie: 300 lm/W im Innenbereich (LED 3030) und 58 % weniger Energie als ein Standard-LED-Modul bei gleichem Lichtstrom (2.000 lm). Für neue und bestehende Leuchten.",
      "meta.locale": "de_DE",
    "a11y.menu": "Menü",
    ...
    "cct.label": "Farbtemperatur",
      ...
      "hero.title_a": "300 Lumen pro Watt,", "hero.title_b": "in jeder Leuchte.",
      "hero.sub": "LED-Module mit patentierter Dicrotec-Technologie, für Hersteller, Planer und Infrastrukturbetreiber. 300 lm/W in Innenmodulen (LED 3030). Sie passen in neue Leuchten und ersetzen die Lichtquelle in bereits installierten.",
      "hero.cta1": "Datenblatt anfordern", "hero.cta2": "Die Bereiche ansehen",
      "scale.label": "Lichtausbeute · Lumen pro Watt", "scale.axis": "Skala 0 – 350 lm/W",
      "scale.inc": "Glühlampe", "scale.fluo": "Leuchtstofflampe", "scale.mh": "Halogen-Metalldampf",
      "scale.led": "Handelsübliche LED", "scale.self": "Wir",
      "scale.note": "Die Vergleichswerte sind typische Marktbereiche der jeweiligen Technologie. Unser Wert: Dicrotec-Innenmodul, LED 3030, LM-79-Prüfung in einem akkreditierten Labor (NVLAP).",
      "metrics.aria": "Kennzahlen", "metrics.efficacy": "Innenmodul · LED 3030", "metrics.energy": "ggü. Standard-LED · 2.000 lm",
      "metrics.compat_v": "Klasse A",
      "plat.label": "Wir",
      "plat.title": "Der notwendige Wandel ist da.",
      "plat.body": "Europa muss die installierte Beleuchtung durch sparsamere ersetzen. Auf dem europäischen Energielabel beginnt Klasse A bei 210 Lumen pro Watt (Verordnung (EU) 2019/2015). Unsere Innenmodule liefern 300.",
      "plat.cta": "Datenblatt anfordern →",
      "adv.label": "Warum sich der Wechsel lohnt",
      "adv.1t": "Ausbeute oberhalb der Marktgrenze",
      "adv.1b": "300 lm/W in Dicrotec-Innenmodulen. Bei gleichem Lichtstrom (2.000 lm): 6,7 W gegenüber 16 W eines Standard-LED-Moduls.",
    ...
    it: {
      "meta.title": "Almenara — Moduli LED da 300 lm/W con tecnologia Dicrotec",
      "meta.desc": "Moduli LED con tecnologia brevettata Dicrotec: 300 lm/W per interni (LED 3030) e il 58% di energia in meno rispetto a un modulo LED standard a pari flusso (2.000 lm). Per apparecchi nuovi ed esistenti.",
      "meta.locale": "it_IT",
    "a11y.menu": "Menu",
    "form.sending": "Invio…",
    ...
    "cct.label": "Temperatura di colore",
      ...
      "hero.title_a": "300 lumen per watt,", "hero.title_b": "su qualsiasi apparecchio.",
      "hero.sub": "Moduli LED con tecnologia brevettata Dicrotec, per produttori, progettisti e gestori di infrastrutture. 300 lm/W nei moduli per interni (LED 3030). Si integrano negli apparecchi nuovi e sostituiscono la sorgente luminosa in quelli già installati.",
      "hero.cta1": "Richiedi la scheda tecnica", "hero.cta2": "Vedi i settori",
      "scale.label": "Efficienza luminosa · lumen per watt", "scale.axis": "Scala 0 – 350 lm/W",
      "scale.inc": "Incandescenza", "scale.fluo": "Fluorescente", "scale.mh": "Ioduri metallici",
      "scale.led": "LED commerciale", "scale.self": "Noi",
      "scale.note": "I valori di confronto sono intervalli tipici di mercato per ogni tecnologia. Il nostro valore: modulo per interni Dicrotec, LED 3030, prova LM-79 in laboratorio accreditato (NVLAP).",
      "metrics.aria": "Dati principali", "metrics.efficacy": "Modulo per interni · LED 3030", "metrics.energy": "rispetto a LED standard · 2.000 lm",
      "metrics.compat_v": "Classe A",
      "plat.label": "Noi",
      "plat.title": "Il cambiamento necessario è qui.",
      "plat.body": "L'Europa deve sostituire l'illuminazione installata con una che consumi meno. Sull'etichetta energetica europea, la classe A parte da 210 lumen per watt (Regolamento (UE) 2019/2015). I nostri moduli per interni ne danno 300.",
      "plat.cta": "Richiedi la scheda tecnica →",
      "adv.label": "Perché conviene cambiare",
      "adv.1t": "Efficienza oltre il tetto commerciale",
      "adv.1b": "300 lm/W nei moduli per interni Dicrotec. A pari flusso (2.000 lm): 6,7 W contro 16 W di un modulo LED standard.",
    ...
    ru: {
      "meta.title": "Almenara — светодиодные модули 300 лм/Вт с технологией Dicrotec",
      "meta.desc": "Светодиодные модули с запатентованной технологией Dicrotec: 300 лм/Вт для помещений (LED 3030) и на 58% меньше энергии, чем стандартный светодиодный модуль при равном световом потоке (2 000 лм). Для новых и установленных светильников.",
      "meta.locale": "ru_RU",
    "a11y.menu": "Меню",
    ...
    "cct.label": "Цветовая температура",
      ...
      "hero.title_a": "300 люмен на ватт —", "hero.title_b": "в любом светильнике.",
      "hero.sub": "Светодиодные модули с запатентованной технологией Dicrotec для производителей, проектировщиков и операторов инфраструктуры. 300 лм/Вт в модулях для помещений (LED 3030). Подходят для новых светильников и заменяют источник света в уже установленных.",
      "hero.cta1": "Запросить техническое описание", "hero.cta2": "Посмотреть отрасли",
      "scale.label": "Световая отдача · люмен на ватт", "scale.axis": "Шкала 0 – 350 лм/Вт",
      ...
      "scale.note": "Значения для сравнения — типичные рыночные диапазоны для каждой технологии. Наше значение: модуль Dicrotec для помещений, LED 3030, испытание LM-79 в аккредитованной лаборатории (NVLAP).",
      "metrics.aria": "Ключевые показатели", "metrics.efficacy": "Модуль для помещений · LED 3030", "metrics.energy": "против стандартного LED · 2 000 лм",
      "metrics.compat_v": "Класс A",
      "plat.label": "О нас",
      "plat.title": "Необходимая перемена уже здесь.",
      "plat.body": "Европе предстоит заменить установленное освещение на более экономичное. На европейской энергетической этикетке класс A начинается с 210 люмен на ватт (Регламент (ЕС) 2019/2015). Наши модули для помещений дают 300.",
      "plat.cta": "Запросить техническое описание →",
      "adv.label": "Почему переход оправдан",
      "adv.1t": "Отдача выше рыночного потолка",
      "adv.1b": "300 лм/Вт в модулях Dicrotec для помещений. При равном световом потоке (2 000 лм): 6,7 Вт против 16 Вт у стандартного светодиодного модуля.",
  ...
  const I18N_PAGES = {
    ...
    en: {
      "tech.spec.warranty_v": "10 years, at maximum rated current and temperature",
      "tech.spec.warranty": "Warranty",
      "tech.spec.patent_v": "MX 383389 · filed in 33 further countries",
      "tech.spec.patent": "Patent",
      "tech.spec.life_v": "> 100,000 h (standard: < 50,000 h)",
      "tech.spec.life": "Nominal life",
      "tech.spec.energy_v": "−58% indoor (2,000 lm) · −46% outdoor (8,400 lm)",
      "tech.spec.efficacy_v": "300 lm/W indoor (LED 3030) · 230–235 lm/W outdoor (LED 5050)",
      "metrics.life": "Nominal life",
      "nav.partners": "Partners",
      "part.meta.title": "Partners — Almenara",
      "part.meta.desc": "Partner with Almenara: technology licence, licensed manufacturing, distribution and installation of Dicrotec LED modules at 300 lm/W (indoor, LED 3030). Terms agreed with each partner.",
      ...
      "tech.specs.note": "Indoor efficacy: LM-79 test at an accredited laboratory (NVLAP). Other figures: technical datasheet. Each with its measurement condition.",
    ...
    es: {
      "tech.spec.warranty_v": "10 años, a corriente y temperatura máximas nominales",
      "tech.spec.warranty": "Garantía",
      "tech.spec.patent_v": "MX 383389 · solicitada en 33 países más",
      "tech.spec.patent": "Patente",
      "tech.spec.life_v": "> 100.000 h (estándar: < 50.000 h)",
      "tech.spec.life": "Vida útil nominal",
      "tech.spec.energy_v": "−58% interior (2.000 lm) · −46% exterior (8.400 lm)",
      "tech.spec.efficacy_v": "300 lm/W interior (LED 3030) · 230–235 lm/W exterior (LED 5050)",
      "metrics.life": "Vida útil nominal",
      "nav.partners": "Socios",
      "part.meta.title": "Socios — Almenara",
      "part.meta.desc": "Socios de Almenara: licencia tecnológica, fabricación bajo licencia, distribución e instalación de módulos LED Dicrotec de 300 lm/W (interior, LED 3030). Condiciones acordadas con cada socio.",
      "part.eyebrow": "Socios",
      ...
      "tech.specs.note": "Eficacia interior: ensayo LM-79 en laboratorio acreditado (NVLAP). Resto de cifras: ficha técnica. Cada una con su condición de medida.",
    ...
    pt: {
      "tech.spec.warranty_v": "10 anos, à corrente e temperatura máximas nominais",
      "tech.spec.warranty": "Garantia",
      "tech.spec.patent_v": "MX 383389 · pedida em mais 33 países",
      "tech.spec.patent": "Patente",
      "tech.spec.life_v": "> 100.000 h (padrão: < 50.000 h)",
      "tech.spec.life": "Vida útil nominal",
      "tech.spec.energy_v": "−58% interior (2.000 lm) · −46% exterior (8.400 lm)",
      "tech.spec.efficacy_v": "300 lm/W interior (LED 3030) · 230–235 lm/W exterior (LED 5050)",
      "metrics.life": "Vida útil nominal",
      ...
      "part.meta.desc": "Parceiros da Almenara: licença tecnológica, fabrico sob licença, distribuição e instalação de módulos LED Dicrotec de 300 lm/W (interior, LED 3030). Condições acordadas com cada parceiro.",
      ...
      "tech.specs.note": "Eficácia interior: ensaio LM-79 em laboratório acreditado (NVLAP). Restantes valores: ficha técnica. Cada um com a sua condição de medida.",
    ...
    fr: {
      "tech.spec.warranty_v": "10 ans, au courant et à la température maximaux nominaux",
      "tech.spec.warranty": "Garantie",
      "tech.spec.patent_v": "MX 383389 · demandé dans 33 autres pays",
      "tech.spec.patent": "Brevet",
      "tech.spec.life_v": "> 100 000 h (standard : < 50 000 h)",
      "tech.spec.life": "Durée de vie nominale",
      "tech.spec.energy_v": "−58 % intérieur (2 000 lm) · −46 % extérieur (8 400 lm)",
      "tech.spec.efficacy_v": "300 lm/W intérieur (LED 3030) · 230–235 lm/W extérieur (LED 5050)",
      "metrics.life": "Durée de vie nominale",
      "nav.partners": "Partenaires",
      "part.meta.title": "Partenaires — Almenara",
      "part.meta.desc": "Partenaires d'Almenara : licence technologique, fabrication sous licence, distribution et installation de modules LED Dicrotec à 300 lm/W (intérieur, LED 3030). Conditions convenues avec chaque partenaire.",
      ...
      "tech.spec.cert": "Certification",
      "tech.specs.note": "Efficacité intérieure : essai LM-79 en laboratoire accrédité (NVLAP). Autres valeurs : fiche technique. Chacune avec sa condition de mesure.",
    ...
    de: {
      "tech.spec.warranty_v": "10 Jahre, bei maximalem Nennstrom und maximaler Nenntemperatur",
      "tech.spec.warranty": "Garantie",
      "tech.spec.patent_v": "MX 383389 · in 33 weiteren Ländern angemeldet",
      "tech.spec.patent": "Patent",
      "tech.spec.life_v": "> 100.000 h (Standard: < 50.000 h)",
      "tech.spec.life": "Nennlebensdauer",
      "tech.spec.energy_v": "−58 % innen (2.000 lm) · −46 % außen (8.400 lm)",
      "tech.spec.efficacy_v": "300 lm/W innen (LED 3030) · 230–235 lm/W außen (LED 5050)",
      "metrics.life": "Nennlebensdauer",
      "nav.partners": "Partner",
      "part.meta.title": "Partner — Almenara",
      "part.meta.desc": "Partner von Almenara: Technologielizenz, Lizenzfertigung, Vertrieb und Installation von Dicrotec-LED-Modulen mit 300 lm/W (innen, LED 3030). Konditionen werden mit jedem Partner vereinbart.",
      ...
      "tech.specs.note": "Lichtausbeute innen: LM-79-Prüfung in einem akkreditierten Labor (NVLAP). Übrige Werte: technisches Datenblatt. Jeweils mit ihrer Messbedingung.",
    ...
    it: {
      "tech.spec.warranty_v": "10 anni, a corrente e temperatura massime nominali",
      "tech.spec.warranty": "Garanzia",
      "tech.spec.patent_v": "MX 383389 · richiesto in altri 33 paesi",
      "tech.spec.patent": "Brevetto",
      "tech.spec.life_v": "> 100.000 h (standard: < 50.000 h)",
      "tech.spec.life": "Vita utile nominale",
      "tech.spec.energy_v": "−58% interni (2.000 lm) · −46% esterni (8.400 lm)",
      "tech.spec.efficacy_v": "300 lm/W interni (LED 3030) · 230–235 lm/W esterni (LED 5050)",
      "metrics.life": "Vita utile nominale",
      "nav.partners": "Partner",
      "part.meta.title": "Partner — Almenara",
      "part.meta.desc": "Partner di Almenara: licenza tecnologica, produzione su licenza, distribuzione e installazione di moduli LED Dicrotec da 300 lm/W (interni, LED 3030). Condizioni concordate con ogni partner.",
      "part.eyebrow": "Partner",
      ...
      "tech.specs.note": "Efficienza per interni: prova LM-79 in laboratorio accreditato (NVLAP). Altri valori: scheda tecnica. Ciascuno con la sua condizione di misura.",
    ...
    ru: {
      "tech.spec.warranty_v": "10 лет при максимальных номинальных токе и температуре",
      "tech.spec.warranty": "Гарантия",
      "tech.spec.patent_v": "MX 383389 · заявлен ещё в 33 странах",
      "tech.spec.patent": "Патент",
      "tech.spec.life_v": "> 100 000 ч (стандарт: < 50 000 ч)",
      "tech.spec.life": "Номинальный срок службы",
      "tech.spec.energy_v": "−58% для помещений (2 000 лм) · −46% наружные (8 400 лм)",
      "tech.spec.efficacy_v": "300 лм/Вт для помещений (LED 3030) · 230–235 лм/Вт наружные (LED 5050)",
      "metrics.life": "Номинальный срок службы",
      "nav.partners": "Партнёрам",
      "part.meta.title": "Партнёрам — Almenara",
      "part.meta.desc": "Партнёрство с Almenara: технологическая лицензия, производство по лицензии, дистрибуция и монтаж светодиодных модулей Dicrotec 300 лм/Вт (для помещений, LED 3030). Условия согласуются с каждым партнёром.",
      ...
      "tech.specs.note": "Световая отдача для помещений: испытание LM-79 в аккредитованной лаборатории (NVLAP). Остальные значения — по технической спецификации, каждое с условием измерения.",
