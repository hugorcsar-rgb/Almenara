...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const I18N_PAGES = {
    ...
    en: {
      ...
      "part.meta.desc": "Partner with Almenara: technology licensing, licensed manufacturing, distribution and integration of an LED platform above 275 lumens per watt. Terms agreed with each partner.",
      "part.eyebrow": "Partners",
      "part.title": "Take the technology to your market.",
      "part.sub": "We are looking for companies to license, manufacture, distribute and install the Almenara platform in their territory. Four ways to join; the terms of each are agreed with every partner.",
      "part.why.label": "Why partner with us",
      "part.w1t": "Ahead of what the market sells",
      "part.w1b": "More than 275 lumens per watt, above the ceiling of today's commercial luminaires. A product your competitors cannot offer.",
      "part.w2t": "It adds to your range",
      "part.w2b": "It covers the efficacy bracket you cannot reach today, without competing with what you already sell.",
      "part.w3t": "Demand that regulation creates",
      "part.w3b": "European efficiency directives push to replace installed lighting with something that consumes less. Every tender that scores consumption is an opening.",
      "part.models.label": "Four partnership models",
      "part.1t": "Technology licence",
      "part.1b": "For manufacturers who want to integrate the technology into their own luminaires and modules, under their own brand.",
      "part.2t": "Licensed manufacturing",
      "part.2b": "For industrial groups who want to produce the platform in their own region, closer to their customers, under licence from Almenara.",
      "part.3t": "Distribution",
      "part.3b": "For distributors who want to sell the finished modules in their territory to manufacturers, installers and specifiers.",
      "part.4t": "Integration and installation",
      "part.4b": "For engineering firms and installers who carry out retrofit projects in public, industrial and commercial installations.",
      "part.terms.label": "Terms",
      "part.terms.title": "Every agreement is built for its market.",
      "part.terms.body": "Territory, exclusivity and economic conditions are negotiated with each partner, according to the market and the commitment of each party. They are discussed in private, not published.",
      "part.steps.label": "How it starts",
      "part.s1t": "Introduce your company",
      "part.s1b": "Who you are, where you operate and which model interests you.",
      "part.s2t": "Meeting",
      "part.s2b": "We present the platform and assess together how it fits your market.",
      "part.s3t": "Agreement",
      "part.s3b": "Territory, scope and conditions set out in a contract made for each partner.",
      "part.cta.label": "Next step",
      "part.cta.title": "Tell us where you want to take it.",
      "part.cta.body": "Write to us with your company, your territory and the model that interests you. We answer within one working day.",
    ...
    es: {
      ...
      "part.meta.desc": "Asóciese con Almenara: licencia tecnológica, fabricación bajo licencia, distribución e integración de una plataforma LED de más de 275 lúmenes por vatio. Condiciones acordadas con cada socio.",
      "part.eyebrow": "Socios",
      "part.title": "Lleve la tecnología a su mercado.",
      "part.sub": "Buscamos empresas que licencien, fabriquen, distribuyan e instalen la plataforma Almenara en su territorio. Cuatro formas de sumarse; las condiciones de cada una se acuerdan con cada socio.",
      "part.why.label": "Por qué asociarse",
      "part.w1t": "Por delante de lo que vende el mercado",
      "part.w1b": "Más de 275 lúmenes por vatio, por encima del techo de las luminarias comerciales actuales. Un producto que su competencia no puede ofrecer.",
      "part.w2t": "Suma a su gama",
      "part.w2b": "Cubre el tramo de eficacia al que hoy no llega, sin competir con lo que ya vende.",
      "part.w3t": "Demanda que crea la normativa",
      "part.w3b": "Las directivas europeas de eficiencia empujan a sustituir la iluminación instalada por otra que consuma menos. Cada licitación que puntúa el consumo es una oportunidad.",
      "part.models.label": "Cuatro modelos de colaboración",
      "part.1t": "Licencia tecnológica",
      "part.1b": "Para fabricantes que quieren integrar la tecnología en sus propias luminarias y módulos, con su propia marca.",
      "part.2t": "Fabricación bajo licencia",
      "part.2b": "Para grupos industriales que quieren producir la plataforma en su región, más cerca de sus clientes, con licencia de Almenara.",
      "part.3t": "Distribución",
      "part.3b": "Para distribuidores que quieren vender los módulos terminados en su territorio a fabricantes, instaladores y prescriptores.",
      "part.4t": "Integración e instalación",
      "part.4b": "Para ingenierías e instaladores que ejecutan proyectos de reforma en instalaciones públicas, industriales y comerciales.",
      "part.terms.label": "Condiciones",
      "part.terms.title": "Cada acuerdo se hace a la medida de su mercado.",
      "part.terms.body": "El territorio, la exclusividad y las condiciones económicas se negocian con cada socio, según el mercado y el compromiso de cada parte. Se tratan en privado, no se publican.",
      "part.steps.label": "Cómo empieza",
      "part.s1t": "Presente su empresa",
      "part.s1b": "Quiénes son, dónde operan y qué modelo les interesa.",
      "part.s2t": "Reunión",
      "part.s2b": "Presentamos la plataforma y valoramos juntos cómo encaja en su mercado.",
      "part.s3t": "Acuerdo",
      "part.s3b": "Territorio, alcance y condiciones, recogidos en un contrato hecho para cada socio.",
      "part.cta.label": "Siguiente paso",
      "part.cta.title": "Díganos adónde quiere llevarla.",
      "part.cta.body": "Escríbanos con su empresa, su territorio y el modelo que le interesa. Respondemos en un día laborable.",
      "part.cta.btn": "Proponer una colaboración",
    ...
    pt: {
      ...
      "part.meta.desc": "Seja parceiro da Almenara: licença tecnológica, fabrico sob licença, distribuição e integração de uma plataforma LED com mais de 275 lúmens por watt. Condições acordadas com cada parceiro.",
      "part.eyebrow": "Parceiros",
      "part.title": "Leve a tecnologia ao seu mercado.",
      "part.sub": "Procuramos empresas que licenciem, fabriquem, distribuam e instalem a plataforma Almenara no seu território. Quatro formas de aderir; as condições de cada uma são acordadas com cada parceiro.",
      "part.why.label": "Porquê ser parceiro",
      "part.w1t": "À frente do que o mercado vende",
      "part.w1b": "Mais de 275 lúmens por watt, acima do teto das luminárias comerciais atuais. Um produto que a sua concorrência não pode oferecer.",
      "part.w2t": "Acrescenta à sua gama",
      "part.w2b": "Cobre o escalão de eficácia que hoje não alcança, sem competir com o que já vende.",
      "part.w3t": "Procura criada pela regulamentação",
      "part.w3b": "As diretivas europeias de eficiência impulsionam a substituição da iluminação instalada por outra que consuma menos. Cada concurso que pontua o consumo é uma oportunidade.",
      "part.models.label": "Quatro modelos de parceria",
      "part.1t": "Licença tecnológica",
      "part.1b": "Para fabricantes que querem integrar a tecnologia nas suas próprias luminárias e módulos, com a sua própria marca.",
      "part.2t": "Fabrico sob licença",
      "part.2b": "Para grupos industriais que querem produzir a plataforma na sua região, mais perto dos seus clientes, sob licença da Almenara.",
      "part.3t": "Distribuição",
      "part.3b": "Para distribuidores que querem vender os módulos acabados no seu território a fabricantes, instaladores e projetistas.",
      "part.4t": "Integração e instalação",
      "part.4b": "Para empresas de engenharia e instaladores que executam projetos de remodelação em instalações públicas, industriais e comerciais.",
      "part.terms.label": "Condições",
      "part.terms.title": "Cada acordo é feito à medida do seu mercado.",
      "part.terms.body": "O território, a exclusividade e as condições económicas são negociados com cada parceiro, de acordo com o mercado e o compromisso de cada parte. São tratados em privado, não são publicados.",
      "part.steps.label": "Como começa",
      "part.s1t": "Apresente a sua empresa",
      "part.s1b": "Quem são, onde operam e que modelo lhes interessa.",
      "part.s2t": "Reunião",
      "part.s2b": "Apresentamos a plataforma e avaliamos em conjunto como se adapta ao seu mercado.",
      "part.s3t": "Acordo",
      "part.s3b": "Território, âmbito e condições, fixados num contrato feito para cada parceiro.",
      "part.cta.label": "Próximo passo",
      "part.cta.title": "Diga-nos onde a quer levar.",
      "part.cta.body": "Escreva-nos com a sua empresa, o seu território e o modelo que lhe interessa. Respondemos num dia útil.",
      "part.cta.btn": "Propor uma parceria",
    ...
    fr: {
      ...
      "part.meta.desc": "Devenez partenaire d'Almenara : licence technologique, fabrication sous licence, distribution et intégration d'une plateforme LED de plus de 275 lumens par watt. Conditions convenues avec chaque partenaire.",
      "part.eyebrow": "Partenaires",
      "part.title": "Portez la technologie sur votre marché.",
      "part.sub": "Nous recherchons des entreprises pour licencier, fabriquer, distribuer et installer la plateforme Almenara sur leur territoire. Quatre façons de nous rejoindre ; les conditions de chacune sont convenues avec chaque partenaire.",
      "part.why.label": "Pourquoi devenir partenaire",
      "part.w1t": "En avance sur ce que vend le marché",
      "part.w1b": "Plus de 275 lumens par watt, au-delà du plafond des luminaires commerciaux actuels. Un produit que vos concurrents ne peuvent pas proposer.",
      "part.w2t": "Elle complète votre gamme",
      "part.w2b": "Elle couvre la tranche d'efficacité que vous n'atteignez pas aujourd'hui, sans concurrencer ce que vous vendez déjà.",
      "part.w3t": "Une demande créée par la réglementation",
      "part.w3b": "Les directives européennes sur l'efficacité poussent à remplacer l'éclairage installé par un éclairage qui consomme moins. Chaque appel d'offres qui note la consommation est une ouverture.",
      "part.models.label": "Quatre modèles de partenariat",
      "part.1t": "Licence technologique",
      "part.1b": "Pour les fabricants qui souhaitent intégrer la technologie dans leurs propres luminaires et modules, sous leur propre marque.",
      "part.2t": "Fabrication sous licence",
      "part.2b": "Pour les groupes industriels qui souhaitent produire la plateforme dans leur région, au plus près de leurs clients, sous licence Almenara.",
      "part.3t": "Distribution",
      "part.3b": "Pour les distributeurs qui souhaitent vendre les modules finis sur leur territoire aux fabricants, installateurs et prescripteurs.",
      "part.4t": "Intégration et installation",
      "part.4b": "Pour les bureaux d'études et installateurs qui réalisent des projets de rénovation dans des installations publiques, industrielles et commerciales.",
      "part.terms.label": "Conditions",
      "part.terms.title": "Chaque accord est conçu pour son marché.",
      "part.terms.body": "Le territoire, l'exclusivité et les conditions économiques sont négociés avec chaque partenaire, selon le marché et l'engagement de chaque partie. Ils sont discutés en privé et ne sont pas publiés.",
      "part.steps.label": "Comment cela commence",
      "part.s1t": "Présentez votre entreprise",
      "part.s1b": "Qui vous êtes, où vous opérez et quel modèle vous intéresse.",
      "part.s2t": "Réunion",
      "part.s2b": "Nous présentons la plateforme et évaluons ensemble son adéquation à votre marché.",
      "part.s3t": "Accord",
      "part.s3b": "Territoire, périmètre et conditions, fixés dans un contrat établi pour chaque partenaire.",
      "part.cta.label": "Étape suivante",
      "part.cta.title": "Dites-nous où vous voulez la porter.",
      "part.cta.body": "Écrivez-nous en indiquant votre entreprise, votre territoire et le modèle qui vous intéresse. Nous répondons sous un jour ouvré.",
    ...
    de: {
      ...
      "part.meta.desc": "Partner von Almenara werden: Technologielizenz, Lizenzfertigung, Vertrieb und Integration einer LED-Plattform mit über 275 Lumen pro Watt. Konditionen werden mit jedem Partner vereinbart.",
      "part.eyebrow": "Partner",
      "part.title": "Bringen Sie die Technologie in Ihren Markt.",
      "part.sub": "Wir suchen Unternehmen, die die Almenara-Plattform in ihrem Gebiet lizenzieren, fertigen, vertreiben und installieren. Vier Wege der Zusammenarbeit; die Konditionen werden mit jedem Partner einzeln vereinbart.",
      "part.why.label": "Warum Partner werden",
      "part.w1t": "Dem Marktangebot voraus",
      "part.w1b": "Über 275 Lumen pro Watt, oberhalb der Grenze heutiger kommerzieller Leuchten. Ein Produkt, das Ihre Wettbewerber nicht anbieten können.",
      "part.w2t": "Eine Ergänzung Ihres Sortiments",
      "part.w2b": "Sie deckt das Effizienzsegment ab, das Sie heute nicht erreichen, ohne mit Ihrem bestehenden Angebot zu konkurrieren.",
      "part.w3t": "Nachfrage durch Regulierung",
      "part.w3b": "Die europäischen Effizienzrichtlinien treiben den Ersatz installierter Beleuchtung durch sparsamere voran. Jede Ausschreibung, die den Verbrauch bewertet, ist eine Chance.",
      "part.models.label": "Vier Partnermodelle",
      "part.1t": "Technologielizenz",
      "part.1b": "Für Hersteller, die die Technologie unter eigener Marke in ihre eigenen Leuchten und Module integrieren möchten.",
      "part.2t": "Lizenzfertigung",
      "part.2b": "Für Industriegruppen, die die Plattform in ihrer Region fertigen möchten, näher an ihren Kunden, unter Lizenz von Almenara.",
      "part.3t": "Vertrieb",
      "part.3b": "Für Distributoren, die die fertigen Module in ihrem Gebiet an Hersteller, Installateure und Planer verkaufen möchten.",
      "part.4t": "Integration und Installation",
      "part.4b": "Für Ingenieurbüros und Installateure, die Sanierungsprojekte in öffentlichen, industriellen und gewerblichen Anlagen umsetzen.",
      "part.terms.label": "Konditionen",
      "part.terms.title": "Jede Vereinbarung wird für ihren Markt gestaltet.",
      "part.terms.body": "Gebiet, Exklusivität und wirtschaftliche Konditionen werden mit jedem Partner verhandelt, je nach Markt und Engagement beider Seiten. Sie werden vertraulich besprochen und nicht veröffentlicht.",
      "part.steps.label": "So beginnt es",
      "part.s1t": "Stellen Sie Ihr Unternehmen vor",
      "part.s1b": "Wer Sie sind, wo Sie tätig sind und welches Modell Sie interessiert.",
      "part.s2t": "Gespräch",
      "part.s2b": "Wir stellen die Plattform vor und prüfen gemeinsam, wie sie zu Ihrem Markt passt.",
      "part.s3t": "Vereinbarung",
      "part.s3b": "Gebiet, Umfang und Konditionen, festgehalten in einem Vertrag, der für jeden Partner erstellt wird.",
      "part.cta.label": "Nächster Schritt",
      "part.cta.title": "Sagen Sie uns, wohin Sie sie bringen wollen.",
      "part.cta.body": "Schreiben Sie uns mit Ihrem Unternehmen, Ihrem Gebiet und dem Modell, das Sie interessiert. Wir antworten innerhalb eines Werktags.",
      "part.cta.btn": "Partnerschaft vorschlagen",
    ...
    it: {
      "nav.partners": "Partner",
      "part.meta.title": "Partner — Almenara",
      "part.meta.desc": "Diventa partner di Almenara: licenza tecnologica, produzione su licenza, distribuzione e integrazione di una piattaforma LED oltre i 275 lumen per watt. Condizioni concordate con ogni partner.",
      "part.eyebrow": "Partner",
      "part.title": "Porti la tecnologia nel suo mercato.",
      "part.sub": "Cerchiamo aziende che concedano in licenza, producano, distribuiscano e installino la piattaforma Almenara nel proprio territorio. Quattro modi per aderire; le condizioni di ciascuno si concordano con ogni partner.",
      "part.why.label": "Perché diventare partner",
      "part.w1t": "Oltre ciò che il mercato vende",
      "part.w1b": "Più di 275 lumen per watt, sopra il limite degli apparecchi commerciali di oggi. Un prodotto che i suoi concorrenti non possono offrire.",
      "part.w2t": "Arricchisce la sua gamma",
      "part.w2b": "Copre la fascia di efficienza che oggi non raggiunge, senza competere con ciò che già vende.",
      "part.w3t": "Domanda creata dalla normativa",
      "part.w3b": "Le direttive europee sull'efficienza spingono a sostituire l'illuminazione installata con una che consumi meno. Ogni gara che valuta i consumi è un'opportunità.",
      "part.models.label": "Quattro modelli di partnership",
      "part.1t": "Licenza tecnologica",
      "part.1b": "Per i produttori che vogliono integrare la tecnologia nei propri apparecchi e moduli, con il proprio marchio.",
      "part.2t": "Produzione su licenza",
      "part.2b": "Per i gruppi industriali che vogliono produrre la piattaforma nella propria regione, più vicino ai clienti, su licenza di Almenara.",
      "part.3t": "Distribuzione",
      "part.3b": "Per i distributori che vogliono vendere i moduli finiti nel proprio territorio a produttori, installatori e progettisti.",
      "part.4t": "Integrazione e installazione",
      "part.4b": "Per società di ingegneria e installatori che realizzano progetti di riqualificazione in impianti pubblici, industriali e commerciali.",
      "part.terms.label": "Condizioni",
      "part.terms.title": "Ogni accordo è costruito per il suo mercato.",
      "part.terms.body": "Territorio, esclusiva e condizioni economiche si negoziano con ogni partner, in base al mercato e all'impegno di ciascuna parte. Si discutono in privato e non si pubblicano.",
      "part.steps.label": "Come si inizia",
      "part.s1t": "Presenti la sua azienda",
      "part.s1b": "Chi siete, dove operate e quale modello vi interessa.",
      "part.s2t": "Incontro",
      "part.s2b": "Presentiamo la piattaforma e valutiamo insieme come si adatta al vostro mercato.",
      "part.s3t": "Accordo",
      "part.s3b": "Territorio, perimetro e condizioni, definiti in un contratto redatto per ogni partner.",
      "part.cta.label": "Prossimo passo",
      "part.cta.title": "Ci dica dove vuole portarla.",
      "part.cta.body": "Ci scriva indicando la sua azienda, il suo territorio e il modello che le interessa. Rispondiamo entro un giorno lavorativo.",
      "part.cta.btn": "Proporre una partnership",
    ...
    ru: {
      ...
      "part.meta.desc": "Партнёрство с Almenara: технологическая лицензия, производство по лицензии, дистрибуция и интеграция светодиодной платформы с эффективностью более 275 люмен на ватт. Условия согласуются с каждым партнёром.",
      "part.eyebrow": "Партнёрам",
      "part.title": "Выведите технологию на свой рынок.",
      "part.sub": "Мы ищем компании, которые будут лицензировать, производить, распространять и устанавливать платформу Almenara на своей территории. Четыре формата сотрудничества; условия каждого согласуются с каждым партнёром.",
      "part.why.label": "Почему стоит стать партнёром",
      "part.w1t": "Впереди того, что продаёт рынок",
      "part.w1b": "Более 275 люмен на ватт — выше предела современных коммерческих светильников. Продукт, который ваши конкуренты предложить не могут.",
      "part.w2t": "Дополняет вашу линейку",
      "part.w2b": "Закрывает диапазон эффективности, недоступный вам сегодня, не конкурируя с тем, что вы уже продаёте.",
      "part.w3t": "Спрос, который создаёт регулирование",
      "part.w3b": "Европейские директивы по энергоэффективности подталкивают к замене установленного освещения на более экономичное. Каждый тендер, где оценивается потребление, — это возможность.",
      "part.models.label": "Четыре модели партнёрства",
      "part.1t": "Технологическая лицензия",
      "part.1b": "Для производителей, которые хотят встроить технологию в собственные светильники и модули под своей маркой.",
      "part.2t": "Производство по лицензии",
      "part.2b": "Для промышленных групп, которые хотят выпускать платформу в своём регионе, ближе к клиентам, по лицензии Almenara.",
      "part.3t": "Дистрибуция",
      "part.3b": "Для дистрибьюторов, которые хотят продавать готовые модули на своей территории производителям, монтажникам и проектировщикам.",
      "part.4t": "Интеграция и монтаж",
      "part.4b": "Для инжиниринговых и монтажных компаний, выполняющих проекты модернизации на общественных, промышленных и коммерческих объектах.",
      "part.terms.label": "Условия",
      "part.terms.title": "Каждое соглашение строится под свой рынок.",
      "part.terms.body": "Территория, эксклюзивность и экономические условия обсуждаются с каждым партнёром в зависимости от рынка и обязательств сторон. Они обсуждаются конфиденциально и не публикуются.",
      "part.steps.label": "С чего начать",
      "part.s1t": "Представьте свою компанию",
      "part.s1b": "Кто вы, где работаете и какая модель вас интересует.",
      "part.s2t": "Встреча",
      "part.s2b": "Мы представляем платформу и вместе оцениваем, как она подходит вашему рынку.",
      "part.s3t": "Соглашение",
      "part.s3b": "Территория, объём и условия, закреплённые в договоре, составленном для каждого партнёра.",
      "part.cta.label": "Следующий шаг",
      "part.cta.title": "Расскажите, куда вы хотите её вывести.",
      "part.cta.body": "Напишите нам, указав компанию, территорию и интересующую модель. Мы отвечаем в течение одного рабочего дня.",
      "part.cta.btn": "Предложить партнёрство",
