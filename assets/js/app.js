...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const I18N = {
    ...
    "cct.label": "Colour temperature",
      ...
      "hero.sub": "LED modules for manufacturers, lighting designers and infrastructure operators. They fit new luminaires and replace the light source in those already installed.",
    ...
    "cct.label": "Temperatura de color",
      ...
      "hero.sub": "Módulos LED para fabricantes, proyectistas y operadores de infraestructuras. Se integran en luminarias nuevas y sustituyen la fuente de luz en las ya instaladas.",
    ...
    "cct.label": "Temperatura de cor",
      ...
      "hero.sub": "Módulos LED para fabricantes, projectistas e operadores de infraestruturas. Integram-se em luminárias novas e substituem a fonte de luz nas já instaladas.",
    ...
    "cct.label": "Température de couleur",
      ...
      "hero.sub": "Modules LED pour fabricants, concepteurs lumière et exploitants d'infrastructures. Ils s'intègrent aux luminaires neufs et remplacent la source dans ceux déjà installés.",
    ...
    "cct.label": "Farbtemperatur",
      ...
      "hero.sub": "LED-Module für Hersteller, Lichtplaner und Infrastrukturbetreiber. Sie gehen in neue Leuchten ein und ersetzen die Lichtquelle in bestehenden.",
    ...
    "cct.label": "Temperatura di colore",
      ...
      "hero.sub": "Moduli LED per produttori, progettisti illuminotecnici e gestori di infrastrutture. Si integrano negli apparecchi nuovi e sostituiscono la sorgente in quelli già installati.",
    ...
    "cct.label": "Цветовая температура",
      ...
      "hero.sub": "Светодиодные модули для производителей, светодизайнеров и операторов инфраструктуры. Встраиваются в новые светильники и заменяют источник света в уже установленных.",
  ...
  (function () {
    ...
    const estrecha = window.matchMedia ? window.matchMedia('(max-width: 860px)') : null;
