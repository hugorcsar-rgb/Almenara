...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const I18N = {
    en: {
      "meta.title": "Almenara — 275 lm/W LED modules with Dicrotec technology",
      "meta.desc": "LED modules with patented Dicrotec technology: 275 lm/W indoors (LED 3030) and 56% less energy than a standard LED module at equal flux (2,000 lm). For new and existing luminaires.",
      "meta.locale": "en_GB",
    "a11y.menu": "Menu",
    ...
    "cct.label": "Colour temperature",
      ...
      "hero.sub": "LED modules with patented Dicrotec technology, for manufacturers, specifiers and infrastructure operators. 275 lm/W in indoor modules (LED 3030). They fit new luminaires and replace the light source in those already installed.",
      ...
      "scale.note": "Comparison values are typical market ranges for each technology. Our figure: Dicrotec indoor module, LED 3030, as stated in the technical datasheet.",
      ...
      "plat.body": "Europe has to replace the lighting it has installed with lighting that consumes less. On the European energy label, Class A starts at 210 lumens per watt (Regulation (EU) 2019/2015). Our indoor modules deliver 275.",
      "plat.cta": "Request the technical brief →",
      "adv.label": "Why it is worth the switch",
      "adv.1t": "Efficacy above the commercial ceiling",
      "adv.1b": "275 lm/W in Dicrotec indoor modules. At equal flux (2,000 lm): 7 W against 16 W for a standard LED module.",
    ...
    es: {
      "meta.title": "Almenara — Módulos LED de 275 lm/W con tecnología Dicrotec",
      "meta.desc": "Módulos LED con tecnología patentada Dicrotec: 275 lm/W en interior (LED 3030) y un 56% menos de energía que un módulo LED estándar a igual flujo (2.000 lm). Para luminarias nuevas e instaladas.",
      "meta.locale": "es_ES",
    "a11y.menu": "Menú",
    ...
    "cct.label": "Temperatura de color",
      ...
      "hero.sub": "Módulos LED con tecnología patentada Dicrotec, para fabricantes, prescriptores y operadores de infraestructura. 275 lm/W en módulos interiores (LED 3030). Encajan en luminarias nuevas y sustituyen la fuente de luz en las ya instaladas.",
      ...
      "scale.note": "Los valores de comparación son rangos típicos de mercado para cada tecnología. Nuestra cifra: módulo interior Dicrotec, LED 3030, según la ficha técnica.",
      ...
      "plat.body": "Europa tiene que sustituir la iluminación instalada por otra que consuma menos. En la etiqueta energética europea, la clase A empieza en 210 lúmenes por vatio (Reglamento (UE) 2019/2015). Nuestros módulos interiores dan 275.",
      "plat.cta": "Solicitar la ficha técnica →",
      "adv.label": "Por qué compensa el cambio",
      "adv.1t": "Eficacia por encima del techo comercial",
      "adv.1b": "275 lm/W en módulos interiores Dicrotec. A igual flujo (2.000 lm): 7 W frente a 16 W de un módulo LED estándar.",
    ...
    pt: {
      "meta.title": "Almenara — Módulos LED de 275 lm/W com tecnologia Dicrotec",
      "meta.desc": "Módulos LED com tecnologia patenteada Dicrotec: 275 lm/W em interior (LED 3030) e menos 56% de energia do que um módulo LED padrão com o mesmo fluxo (2.000 lm). Para luminárias novas e instaladas.",
      "meta.locale": "pt_PT",
    "a11y.menu": "Menu",
    ...
    "cct.label": "Temperatura de cor",
      ...
      "hero.title_a": "275 lúmens por watt,", "hero.title_b": "em qualquer luminária.",
      "hero.sub": "Módulos LED com tecnologia patenteada Dicrotec, para fabricantes, projetistas e operadores de infraestruturas. 275 lm/W em módulos interiores (LED 3030). Encaixam em luminárias novas e substituem a fonte de luz nas já instaladas.",
      ...
      "scale.note": "Os valores de comparação são intervalos típicos de mercado para cada tecnologia. O nosso valor: módulo interior Dicrotec, LED 3030, segundo a ficha técnica.",
      ...
      "plat.body": "A Europa tem de substituir a iluminação instalada por outra que consuma menos. Na etiqueta energética europeia, a classe A começa nos 210 lúmens por watt (Regulamento (UE) 2019/2015). Os nossos módulos interiores dão 275.",
      "plat.cta": "Pedir a ficha técnica →",
      "adv.label": "Porque compensa mudar",
      "adv.1t": "Eficácia acima do tecto comercial",
      "adv.1b": "275 lm/W em módulos interiores Dicrotec. Com o mesmo fluxo (2.000 lm): 7 W face a 16 W de um módulo LED padrão.",
    ...
    fr: {
      "meta.title": "Almenara — Modules LED de 275 lm/W avec la technologie Dicrotec",
      "meta.desc": "Modules LED à technologie brevetée Dicrotec : 275 lm/W en intérieur (LED 3030) et 56 % d'énergie en moins qu'un module LED standard à flux égal (2 000 lm). Pour luminaires neufs et existants.",
      "meta.locale": "fr_FR",
    "a11y.menu": "Menu",
    "form.sending": "Envoi…",
    ...
    "cct.label": "Température de couleur",
      ...
      "hero.sub": "Modules LED à technologie brevetée Dicrotec, pour fabricants, prescripteurs et gestionnaires d'infrastructures. 275 lm/W en modules intérieurs (LED 3030). Ils s'intègrent aux luminaires neufs et remplacent la source lumineuse de ceux déjà installés.",
      ...
      "scale.note": "Les valeurs de comparaison sont des plages de marché typiques pour chaque technologie. Notre valeur : module intérieur Dicrotec, LED 3030, selon la fiche technique.",
      ...
      "plat.body": "L'Europe doit remplacer l'éclairage installé par un éclairage qui consomme moins. Sur l'étiquette énergétique européenne, la classe A commence à 210 lumens par watt (Règlement (UE) 2019/2015). Nos modules intérieurs en délivrent 275.",
      ...
      "adv.1b": "275 lm/W dans les modules intérieurs Dicrotec. À flux égal (2 000 lm) : 7 W contre 16 W pour un module LED standard.",
    ...
    de: {
      "meta.title": "Almenara — LED-Module mit 275 lm/W und Dicrotec-Technologie",
      "meta.desc": "LED-Module mit patentierter Dicrotec-Technologie: 275 lm/W im Innenbereich (LED 3030) und 56 % weniger Energie als ein Standard-LED-Modul bei gleichem Lichtstrom (2.000 lm). Für neue und bestehende Leuchten.",
      "meta.locale": "de_DE",
    "a11y.menu": "Menü",
    ...
    "cct.label": "Farbtemperatur",
      ...
      "hero.sub": "LED-Module mit patentierter Dicrotec-Technologie, für Hersteller, Planer und Infrastrukturbetreiber. 275 lm/W in Innenmodulen (LED 3030). Sie passen in neue Leuchten und ersetzen die Lichtquelle in bereits installierten.",
      ...
      "scale.note": "Die Vergleichswerte sind typische Marktbereiche der jeweiligen Technologie. Unser Wert: Dicrotec-Innenmodul, LED 3030, laut technischem Datenblatt.",
      ...
      "plat.body": "Europa muss die installierte Beleuchtung durch sparsamere ersetzen. Auf dem europäischen Energielabel beginnt Klasse A bei 210 Lumen pro Watt (Verordnung (EU) 2019/2015). Unsere Innenmodule liefern 275.",
      "plat.cta": "Datenblatt anfordern →",
      "adv.label": "Warum sich der Wechsel lohnt",
      "adv.1t": "Ausbeute oberhalb der Marktgrenze",
      "adv.1b": "275 lm/W in Dicrotec-Innenmodulen. Bei gleichem Lichtstrom (2.000 lm): 7 W gegenüber 16 W eines Standard-LED-Moduls.",
    ...
    it: {
      "meta.title": "Almenara — Moduli LED da 275 lm/W con tecnologia Dicrotec",
      "meta.desc": "Moduli LED con tecnologia brevettata Dicrotec: 275 lm/W per interni (LED 3030) e il 56% di energia in meno rispetto a un modulo LED standard a pari flusso (2.000 lm). Per apparecchi nuovi ed esistenti.",
      "meta.locale": "it_IT",
    "a11y.menu": "Menu",
    "form.sending": "Invio…",
    ...
    "cct.label": "Temperatura di colore",
      ...
      "hero.sub": "Moduli LED con tecnologia brevettata Dicrotec, per produttori, progettisti e gestori di infrastrutture. 275 lm/W nei moduli per interni (LED 3030). Si integrano negli apparecchi nuovi e sostituiscono la sorgente luminosa in quelli già installati.",
      ...
      "scale.note": "I valori di confronto sono intervalli tipici di mercato per ogni tecnologia. Il nostro valore: modulo per interni Dicrotec, LED 3030, secondo la scheda tecnica.",
      ...
      "plat.body": "L'Europa deve sostituire l'illuminazione installata con una che consumi meno. Sull'etichetta energetica europea, la classe A parte da 210 lumen per watt (Regolamento (UE) 2019/2015). I nostri moduli per interni ne danno 275.",
      "plat.cta": "Richiedi la scheda tecnica →",
      "adv.label": "Perché conviene cambiare",
      "adv.1t": "Efficienza oltre il tetto commerciale",
      "adv.1b": "275 lm/W nei moduli per interni Dicrotec. A pari flusso (2.000 lm): 7 W contro 16 W di un modulo LED standard.",
    ...
    ru: {
      "meta.title": "Almenara — светодиодные модули 275 лм/Вт с технологией Dicrotec",
      "meta.desc": "Светодиодные модули с запатентованной технологией Dicrotec: 275 лм/Вт для помещений (LED 3030) и на 56% меньше энергии, чем стандартный светодиодный модуль при равном световом потоке (2 000 лм). Для новых и установленных светильников.",
      "meta.locale": "ru_RU",
    "a11y.menu": "Меню",
    ...
    "cct.label": "Цветовая температура",
      ...
      "hero.sub": "Светодиодные модули с запатентованной технологией Dicrotec для производителей, проектировщиков и операторов инфраструктуры. 275 лм/Вт в модулях для помещений (LED 3030). Подходят для новых светильников и заменяют источник света в уже установленных.",
      ...
      "scale.note": "Значения для сравнения — типичные рыночные диапазоны для каждой технологии. Наше значение: модуль Dicrotec для помещений, LED 3030, по технической спецификации.",
      ...
      "plat.body": "Европе предстоит заменить установленное освещение на более экономичное. На европейской энергетической этикетке класс A начинается с 210 люмен на ватт (Регламент (ЕС) 2019/2015). Наши модули для помещений дают 275.",
      "plat.cta": "Запросить техническое описание →",
      "adv.label": "Почему переход оправдан",
      "adv.1t": "Отдача выше рыночного потолка",
      "adv.1b": "275 лм/Вт в модулях Dicrotec для помещений. При равном световом потоке (2 000 лм): 7 Вт против 16 Вт у стандартного светодиодного модуля.",
  ...
  const I18N_PAGES = {
    ...
    en: {
      ...
      "tech.spec.energy_v": "−56% indoor (2,000 lm) · −46% outdoor (8,400 lm)",
      "tech.spec.efficacy_v": "275 lm/W indoor (LED 3030) · 230–235 lm/W outdoor (LED 5050)",
      ...
      "tech.specs.note": "Figures as stated in the technical datasheet, each with its measurement condition.",
    ...
    es: {
      ...
      "tech.spec.energy_v": "−56% interior (2.000 lm) · −46% exterior (8.400 lm)",
      "tech.spec.efficacy_v": "275 lm/W interior (LED 3030) · 230–235 lm/W exterior (LED 5050)",
      ...
      "tech.specs.note": "Cifras según la ficha técnica, cada una con su condición de medida.",
    ...
    pt: {
      ...
      "tech.specs.note": "Valores segundo a ficha técnica, cada um com a sua condição de medida.",
    ...
    fr: {
      ...
      "tech.spec.energy_v": "−56 % intérieur (2 000 lm) · −46 % extérieur (8 400 lm)",
      "tech.spec.efficacy_v": "275 lm/W intérieur (LED 3030) · 230–235 lm/W extérieur (LED 5050)",
      ...
      "tech.spec.cert": "Certification",
      "tech.specs.note": "Valeurs selon la fiche technique, chacune avec sa condition de mesure.",
    ...
    de: {
      ...
      "tech.spec.energy_v": "−56 % innen (2.000 lm) · −46 % außen (8.400 lm)",
      "tech.spec.efficacy_v": "275 lm/W innen (LED 3030) · 230–235 lm/W außen (LED 5050)",
      ...
      "tech.specs.note": "Werte laut technischem Datenblatt, jeweils mit ihrer Messbedingung.",
    ...
    it: {
      ...
      "tech.spec.energy_v": "−56% interni (2.000 lm) · −46% esterni (8.400 lm)",
      "tech.spec.efficacy_v": "275 lm/W interni (LED 3030) · 230–235 lm/W esterni (LED 5050)",
      ...
      "tech.specs.note": "Valori secondo la scheda tecnica, ciascuno con la sua condizione di misura.",
    ...
    ru: {
      ...
      "tech.spec.energy_v": "−56% для помещений (2 000 лм) · −46% наружные (8 400 лм)",
      "tech.spec.efficacy_v": "275 лм/Вт для помещений (LED 3030) · 230–235 лм/Вт наружные (LED 5050)",
      ...
      "tech.specs.note": "Значения по технической спецификации, каждое — с условием измерения.",
