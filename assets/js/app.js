...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const I18N = {
    ...
    "app.3alt": "Facade of a heritage building lit at night",
    "app.4alt": "Floodlight mast switched on at dusk",
    ...
    "app.3alt": "Fachada de un edificio histórico iluminada de noche",
    "app.4alt": "Torre de proyectores encendidos al anochecer",
    ...
    "app.3alt": "Fachada de um edifício histórico iluminada à noite",
    "app.4alt": "Torre de projectores acesos ao anoitecer",
    ...
    "app.3alt": "Façade d'un bâtiment patrimonial éclairée la nuit",
    "app.4alt": "Mât de projecteurs allumés au crépuscule",
    ...
    "app.3alt": "Nachts beleuchtete Fassade eines historischen Gebäudes",
    "app.4alt": "Flutlichtmast in der Dämmerung eingeschaltet",
    ...
    "app.3alt": "Facciata di un edificio storico illuminata di notte",
    "app.4alt": "Torre faro accesa al tramonto",
    ...
    "app.3alt": "Фасад исторического здания, освещённый ночью",
    "app.4alt": "Мачта прожекторов, включённая в сумерках",
