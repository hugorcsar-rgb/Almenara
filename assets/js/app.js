...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const I18N_PAGES = {
    ...
    en: {
      ...
      "part.s3t": "Let's talk",
      "part.s3b": "Every partnership is defined together with each partner. Write to us and we will take it from there.",
    ...
    es: {
      ...
      "part.s3t": "Hablemos",
      "part.s3b": "Cada colaboración se define junto a cada socio. Escríbanos y empezamos.",
    ...
    pt: {
      ...
      "part.s3t": "Falemos",
      "part.s3b": "Cada parceria é definida em conjunto com cada parceiro. Escreva-nos e começamos.",
    ...
    fr: {
      ...
      "part.s3t": "Parlons-en",
      "part.s3b": "Chaque partenariat se définit avec chaque partenaire. Écrivez-nous et nous commençons.",
    ...
    de: {
      ...
      "part.s3b": "Jede Partnerschaft wird gemeinsam mit dem jeweiligen Partner gestaltet. Schreiben Sie uns, und wir legen los.",
    ...
    it: {
      ...
      "part.s3t": "Parliamone",
      "part.s3b": "Ogni partnership si definisce insieme a ciascun partner. Ci scriva e cominciamo.",
    ...
    ru: {
      ...
      "part.s3b": "Каждое партнёрство мы выстраиваем вместе с партнёром. Напишите нам — и начнём.",
